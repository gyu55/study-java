...
//         memberDAO.changePassword("1236");
//         memberDAO.deleteAccount();
//         System.out.println(memberDAO.findById());
//         memberDAO.logout();
//         System.out.println("로그아웃 했숑");
         System.out.println(memberDAO.findById());
      }else {
         System.out.println("로그인 실패");
      }
      ArrayList<MemberVO> recommenders = memberDAO.getRecommenders();
      recommenders.forEach(System.out::println);
   }
